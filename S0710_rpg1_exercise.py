...
class Character:
    ...
    def __repr__(self):
        return f"Character(name='{self.name}', max_health='{self.max_health}', _current_health={self._current_health}, attackpower={self.attackpower}"

test = Character("bo", 100, 60, 5)
